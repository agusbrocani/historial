// // // // src/components/TextoExpandible/TextoExpandible.tsx
...
// // //   texto: string;
// // //   /** Color del botón “Ver más / Ver menos” */
// // //   color: string;
// // //   /** Callback opcional que recibe el nuevo estado (true = expandido) */
// // //   onToggle?: (expanded: boolean) => void;
// // //   /** Líneas antes de truncar (por defecto 3) */
// // //   lines?: number;
// // // };
...
// // //     };
// // //     update();
// // //     const obs = new ResizeObserver(() => window.requestAnimationFrame(update));
// // //     if (pRef.current) obs.observe(pRef.current);
...
// // //       <p
// // //         ref={pRef}
// // //         className={expanded ? styles.textoExpanded : styles.textoTruncado}
...
//         // acabo de colapsar: scrollear al inicio de este párrafo
